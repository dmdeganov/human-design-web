export const questionnaire = {
  name: {
    name: 'Name',
    title: 'What is \n your name?',
    description: 'Let’s get acquainted! Please introduce\n yourself so that we know how best to\n address you!',
  },
  birth_date: {
    title: 'Date of birth',
    description: 'enter the date of birth, and we will calculate your personal bodygraph!',
  },
  birth_time: {
    title: 'Time of birth',
    description:
